...
class FillPermissionsForMembresium extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMembresium constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.membresium',
            'admin.membresium.index',
            'admin.membresium.create',
            'admin.membresium.show',
            'admin.membresium.edit',
            'admin.membresium.delete',
            'admin.membresium.bulk-delete',
        ]);
