...
class FillPermissionsForDescuento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDescuento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.descuento',
            'admin.descuento.index',
            'admin.descuento.create',
            'admin.descuento.show',
            'admin.descuento.edit',
            'admin.descuento.delete',
            'admin.descuento.bulk-delete',
        ]);
