                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'nombreProducto'">{{ trans('admin.producto.columns.nombreProducto') }}</th>
                                        <th is='sortable' :column="'valorProducto'">{{ trans('admin.producto.columns.valorProducto') }}</th>
