...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('fechaInicio'), 'has-success': fields.fechaInicio && fields.fechaInicio.valid }">
    <label for="fechaInicio" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.cliente.columns.fechaInicio') }}</label>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('fechaFin'), 'has-success': fields.fechaFin && fields.fechaFin.valid }">
    <label for="fechaFin" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.cliente.columns.fechaFin') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-sm-8'">
        <div class="input-group input-group--custom">
            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('valorTotal'), 'has-success': fields.valorTotal && fields.valorTotal.valid }">
    <label for="valorTotal" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.cliente.columns.valorTotal') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('membresia_id'), 'has-success': fields.membresia_id && fields.membresia_id.valid }">
    <label for="membresia_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.cliente.columns.membresia_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('descuento_id'), 'has-success': fields.descuento_id && fields.descuento_id.valid }">
    <label for="descuento_id" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.cliente.columns.descuento_id') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
