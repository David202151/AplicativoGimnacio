                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'fechaInicio'">{{ trans('admin.cliente.columns.fechaInicio') }}</th>
                                        <th is='sortable' :column="'fechaFin'">{{ trans('admin.cliente.columns.fechaFin') }}</th>
                                        <th is='sortable' :column="'valorTotal'">{{ trans('admin.cliente.columns.valorTotal') }}</th>
                                        <th is='sortable' :column="'membresia_id'">{{ trans('admin.cliente.columns.membresia_id') }}</th>
                                        <th is='sortable' :column="'descuento_id'">{{ trans('admin.cliente.columns.descuento_id') }}</th>
